...
public final class Util {
     ...
     */
    public static String openUrl(String url, final String method, final Bundle params) throws IOException {

        if (method.equals("GET")) {
            url += "?" + encodeUrl(params);
        }
        final HttpURLConnection conn = (HttpURLConnection) new URL(url).openConnection();
        conn.setRequestProperty("User-Agent", System.getProperties().getProperty("http.agent") + " BirthdayApp");
        String response;
        try {
    ...
    public static void clearCookies(final Context context) {
        ...
        @SuppressWarnings("unused") final CookieSyncManager cookieSyncMngr = CookieSyncManager.createInstance(context);
